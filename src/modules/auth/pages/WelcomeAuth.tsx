  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2 mt-4 mb-4">
        <Link
          to="/auth/login"
          className="w-full py-3 px-4 text-sm font-medium rounded-lg cursor-pointer border border-transparent text-center text-gray-800 hover:opacity-75 focus:outline-hidden focus:opacity-75 disabled:opacity-50 disabled:pointer-events-none"
          style={{
